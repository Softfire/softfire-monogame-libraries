...
namespace Softfire.MonoGame.DB.V2
{
    ...
    public interface IRepository<T>
    {
        ...
        /// Get Data Async.
        /// </summary>
        /// <returns>Returns all data from the database, asynchronously.</returns>
        ...
        /// <summary>
        /// Create Async.
        /// Creates a new object entry in the database from the passed in object, asynchronously.
        /// </summary>
        /// <param name="t">Intakes a new object.</param>
        ...
        /// <summary>
        /// Retrieve Async.
        /// Retrieves the requested object by Id, asynchronously.
        /// </summary>
        /// <param name="id">Intakes a object's Id as an int.</param>
        /// <returns>Returns the requested object or null if not found.</returns>
