...
{
    public class RotateCounterClockwise : Transition
    {
        /// <summary>
        ...
        public RotateCounterClockwise(State state, double startRotationAngleInDegrees, double targetRotationAngleInDegrees, float durationInSeconds, float startDelayInSeconds, int orderNumber) : base(state, durationInSeconds, startDelayInSeconds, orderNumber)
        {
