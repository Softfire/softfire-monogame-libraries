...
namespace Softfire.MonoGame.SM.V2.Transitions
{
    public class FadeIn : Transition
    {
        ...
        public FadeIn(State state, float startingTransparencyLevel = 0f, float targetTransparencyLevel = 1f, float durationInSeconds = 1f, float startDelayInSeconds = 0f, int orderNumber = 0) : base(state, durationInSeconds, startDelayInSeconds, orderNumber)
        {
