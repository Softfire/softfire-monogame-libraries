...
namespace Softfire.MonoGame.CORE.V2.Physics.Easings
{
    ...
    /// </summary>
    public class Easing : IMonoGameIdentifierComponent
    {
        /// <summary>
        ...
        /// <summary>
        /// The amplitude changes the height of the curve for <see cref="Elastic"/>.
        /// </summary>
        public double Amplitude { get; set; }

        /// <summary>
        /// The period slows the rate of elastic bounce for <see cref="Elastic"/>.
        /// </summary>
