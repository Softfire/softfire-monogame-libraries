...
namespace Softfire.MonoGame.UI.Effects.Coloring
{
    ...
    /// </summary>
    public class UIEffectFontHighlightColorGradient : UIEffectBase
    {
        /// <summary>
        ...
        public UIEffectFontHighlightColorGradient(UIBase parent, int id, string name, Color targetColor,
        ...
        protected override bool Action()
        {
            ...
            {
                InitialColor = Parent.Colors["FontHighlight"];
                IsFirstRun = false;
            }
            ...
            if (ElapsedTime >= StartDelayInSeconds)
            {
                ...
                Parent.Colors["FontHighlight"] = Color.Lerp(InitialColor, TargetColor, (float)RateOfChange);
            }

            return Parent.Colors["FontHighlight"] == TargetColor && ElapsedTime > DurationInSeconds + StartDelayInSeconds;
        }
