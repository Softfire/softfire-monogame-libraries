...
namespace Softfire.MonoGame.UI.V2.Effects.Coloring
{
    ...
    /// </summary>
    public class UIEffectBackgroundColorGradient : UIEffectBase
    {
        /// <summary>
        ...
        public UIEffectBackgroundColorGradient(UIBase parent, int id, string name, Color targetColor,
        ...
        protected override bool Action()
        {
            ...
            {
                InitialColor = Parent.Colors["Background"];
                IsFirstRun = false;
            }
            ...
            if (ElapsedTime >= StartDelayInSeconds)
            {
                ...
                Parent.Colors["Background"] = Color.Lerp(InitialColor, TargetColor, (float)RateOfChange);
            }

            return Parent.Colors["Background"] == TargetColor && ElapsedTime > DurationInSeconds + StartDelayInSeconds;
        }
