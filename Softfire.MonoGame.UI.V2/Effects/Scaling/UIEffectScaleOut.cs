...
{
    /// <summary>
    /// An effect to scale the UI out along the X and Y axis.
    /// </summary>
    public class UIEffectScaleOut : UIEffectBase
    {
        /// <summary>
        ...
        /// <summary>
        /// An effect that scales the UI out along the X and Y axis.
        /// </summary>
        ...
        public UIEffectScaleOut(UIBase parent, int id, string name, Vector2 targetScale, float durationInSeconds = 1f, float startDelayInSeconds = 0f) : base(parent, id, name, durationInSeconds, startDelayInSeconds)
        {
