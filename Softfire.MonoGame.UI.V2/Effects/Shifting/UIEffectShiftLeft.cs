...
namespace Softfire.MonoGame.UI.V2.Effects.Shifting
{
    /// <summary>
    /// An effect to shift the UI to the left along the X axis from it's current position.
    /// </summary>
    public class UIEffectShiftLeft : UIEffectBase
    {
        /// <summary>
        ...
        /// <summary>
        /// An effect that shifts the UI to the left along the X axis.
        /// </summary>
        ...
        /// <param name="shiftVector">The shift vector (X) to offset the UI by over the duration of time provided. Intaken as a <see cref="Vector2"/>.</param>
        ...
        public UIEffectShiftLeft(UIBase parent, int id, string name, Vector2 shiftVector,
        ...
        protected override bool Action()
        {
            ...
            return Parent.Transform.Position.X <= InitialPosition.X - ShiftVector.X || ElapsedTime > DurationInSeconds + StartDelayInSeconds;
        }
