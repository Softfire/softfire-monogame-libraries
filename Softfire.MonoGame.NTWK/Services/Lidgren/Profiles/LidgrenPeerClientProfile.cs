...
namespace Softfire.MonoGame.NTWK.Services.Lidgren.Profiles
{
    public sealed class LidgrenPeerClientProfile : LidgrenPeerProfile
    {
        ...
        /// <param name="port">The client's listening port. Intaken as an int.</param>
        /// <param name="version">The client's underlying version. Intaken as a double.</param>
