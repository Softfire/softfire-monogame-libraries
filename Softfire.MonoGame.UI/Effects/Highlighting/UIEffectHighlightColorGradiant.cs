...
namespace Softfire.MonoGame.UI.Effects.Highlighting
{
    class UIEffectHighlightColorGradiant : UIEffectBase
    {
        ...
        /// <summary>
        /// UI Effect Highlight Color Gradiant.
        /// </summary>
        ...
        public UIEffectHighlightColorGradiant(UIBase uiBase, Color initialColor, Color targetColor, float durationInSeconds = 1, float startDelayInSeconds = 0, int orderNumber = 0) : base(uiBase, durationInSeconds, startDelayInSeconds, orderNumber)
        {
