...
{
    public class UIEffectFadeIn : UIBaseEffect
    {
        /// <summary>
        ...
        public UIEffectFadeIn(UIBase uiBase, float startingTransparencyLevel = 0f, float targetTransparencyLevel = 1f, float durationInSeconds = 1.0f, float startDelayInSeconds = 0.0f, int orderNumber = 0) : base(uiBase, durationInSeconds, startDelayInSeconds, orderNumber)
        {
