...
{
    public class UIEffectMoveRight : UIBaseEffect
    {
        /// <summary>
        /// Start Position.
        /// </summary>
        ...
        /// <summary>
        /// UI Effect Move Right.
        /// Moves the UIBase right(+) on the X axis.
        /// </summary>
        ...
        public UIEffectMoveRight(UIBase uiBase, Vector2 startPosition, Vector2 targetPosition, float durationInSeconds, float startDelayInSeconds, int orderNumber) : base(uiBase, durationInSeconds, startDelayInSeconds, orderNumber)
        {
