...
namespace Softfire.MonoGame.UI.Effects.Coloring
{
    ...
    /// </summary>
    public class UIEffectHighlightColorGradiant : UIEffectBase
    {
        /// <summary>
        ...
        public UIEffectHighlightColorGradiant(UIBase uiBase, int id, string name, Color targetColor,
        ...
        {
            InitialColor = ParentUIBase.Colors["Highlight"];
