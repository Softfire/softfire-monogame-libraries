...
namespace Softfire.MonoGame.UI.Effects.Coloring
{
    ...
    public class UIEffectBackgroundColorGradient : UIEffectBase
    {
        ...
        public UIEffectBackgroundColorGradient(UIBase uiBase, int id, string name, Color targetColor,
        ...
        protected override bool Action()
        {
            if (ElapsedTime >= StartDelayInSeconds)
            {
                ...
                ParentUIBase.Colors["Background"] = Color.Lerp(ParentUIBase.Colors["Background"], TargetColor, (float)RateOfChange);
            }
