...
using Softfire.MonoGame.UI.V2.Effects.Coloring;
using Softfire.MonoGame.UI.V2.Effects.Scaling;
using Softfire.MonoGame.UI.V2.Effects.Shifting;

namespace Softfire.MonoGame.Demos.UI.WinDX
{
    /// <summary>
